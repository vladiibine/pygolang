...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','simple_calc.py',56),
  ('statement -> expression','statement',1,'p_statement_expr','simple_calc.py',61),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','simple_calc.py',66),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','simple_calc.py',67),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','simple_calc.py',68),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','simple_calc.py',69),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','simple_calc.py',81),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','simple_calc.py',86),
  ('expression -> NUMBER','expression',1,'p_expression_number','simple_calc.py',91),
  ('expression -> NAME','expression',1,'p_expression_name','simple_calc.py',96),
]
